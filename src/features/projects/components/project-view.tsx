...
export const ProjectView = () => {
  ...
  return (
    ...
    <div className="min-h-screen flex flex-col bg-sidebar items-center justify-center p-6 md:p-16">
      <div className="w-full max-w-sm mx-auto flex flex-col gap-4 items-center">
        <div className="flex gap-2 w-full items-center group/logo">
            <img src="/vercel.svg" alt="Code-Council" className="size-[32px] md:size-[46px]" />
            <h1 className={cn("text-4xl md:text-5xl font-semibold",font.className)}>Code Council</h1>
        </div>
