...
const ContinueCard = ({data}:{data:Doc<"projects">})=>{
    return (
        <div className="flex flex-col gap-2">
          ...
          <Button variant="outline" asChild className="h-auto flex flex-col items-start justify-start p-4
           border rounded-none gap-2 bg-background
          ">
...
const ProjectItem = ({data}:{
    ...
    return(
        ...
        <span className="text-xs text-muted-foreground font-medium group-hover:text-foreground/60 transition-colors">
            {formatTimestamp(data.updatedAt)}
        </span>
        </Link>
    )
